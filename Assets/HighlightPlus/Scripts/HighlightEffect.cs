...
namespace HighlightPlus
{
    ...
    public partial class HighlightEffect : MonoBehaviour
    {
        ...
        Material fxMatTarget
        {
            get
            {
                if (_fxMatTarget == null && fxMatTargetRef != null)
                    _fxMatTarget = Instantiate(fxMatTargetRef);
                return _fxMatTarget;
            }
        }
        ...
        Material fxMatComposeGlow
        {
            get
            {
                if (_fxMatComposeGlow == null && fxMatComposeGlowRef != null)
                    _fxMatComposeGlow = Instantiate(fxMatComposeGlowRef);
        ...
        Material fxMatComposeOutline
        {
            get
            {
                if (_fxMatComposeOutline == null && fxMatComposeOutlineRef != null)
                    _fxMatComposeOutline = Instantiate(fxMatComposeOutlineRef);
        ...
        Material fxMatBlurGlow
        {
            get
            {
                if (_fxMatBlurGlow == null && fxMatBlurGlowRef != null)
                    _fxMatBlurGlow = Instantiate(fxMatBlurGlowRef);
        ...
        Material fxMatBlurOutline
        {
            get
            {
                if (_fxMatBlurOutline == null && fxMatBlurOutlineRef != null)
                    _fxMatBlurOutline = Instantiate(fxMatBlurOutlineRef);
        ...
        void RenderEffect(Camera cam)
        {
            ...
            if (cam == null || ((1 << cam.gameObject.layer) & camerasLayerMask) == 0)
                return;
        ...
        void SetupMaterial(Renderer[] rr)
        {
            ...
            for (int k = 0; k < rr.Length; k++)
            {
                ...
                {
                    if (!renderer.name.Contains(effectNameFilter))
                        continue;
                }
        ...
        void UpdateMaterialPropertiesNow()
        {
            ...
            matGlow.SetVector(ShaderParams.Glow2 , new Vector4(normalsOption == NormalsOption.Planar ? 0 : outlineWidth / 100f , glowAnimationSpeed , glowDithering));
        ...
        void CombineMeshes()
        {
            ...
            for (int k = 0; k < rmsCount; k++)
            {
                ...
                if (vertexCount + mesh.vertexCount > MAX_VERTEX_COUNT)
                    continue;

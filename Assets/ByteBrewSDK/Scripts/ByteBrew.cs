...
namespace ByteBrewSDK
{
    public class ByteBrew : MonoBehaviour
    {
        ...
        public static void OnLevelStart(string environment, string levelName)
        {
            //ByteBrew.TrackLevelProgression(levelName, ByteBrewProgressionEvent.START);
           // ByteBrew.NewProgressionEvent(ByteBrewProgressionTypes.Started,environment, levelName);
        }

        public static void OnLevelComplete(string levelName)
        {
            
         //   ByteBrew.NewProgressionEvent(ByteBrewProgressionTypes.Completed, levelName);
        }

        public static void OnLevelFail(string levelName)
        {
           // ByteBrew.NewProgressionEvent(ByteBrewProgressionTypes.Failed, levelName);
        }
        /// <summary>
        /// Add a custom event to be tracked in ByteBrew
        /// </summary>
       ...
       /* public static void NewProgressionEvent(ByteBrewProgressionTypes progressionStatus, string stage)
        {

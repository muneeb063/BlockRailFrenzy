    ...
    public class LivesManager : MonoBehaviour
    {
        ...
        private class LivesSave : ISaveObject
        {
            ...
            public void SaveLivesData()
            {
                ...
                PlayerPrefs.SetString("DateBinary", date.ToBinary().ToString());
                PlayerPrefs.SetInt("InfiniteLives", infiniteLives ? 1 : 0);
                PlayerPrefs.Save();
            }
            public void Init(LivesData data)
            {
                ...
                {
                    livesCount = PlayerPrefs.GetInt("LivesCount", data.maxLivesCount);
                    long dateBinary = long.Parse(PlayerPrefs.GetString("DateBinary", DateTime.Now.ToBinary().ToString()));
                    infiniteLives = PlayerPrefs.GetInt("InfiniteLives", 0) == 1;

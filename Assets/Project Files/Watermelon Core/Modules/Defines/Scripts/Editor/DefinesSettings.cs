...
namespace Watermelon
{
    public static class DefinesSettings
    {
        ...
        public static readonly RegisteredDefine[] STATIC_REGISTERED_DEFINES = new RegisteredDefine[]
        {
            ...
            // Core
            new RegisteredDefine("MODULE_MONETIZATION", "Watermelon.Monetization", new string[] { "{CORE_MODULES}Monetization/Scripts/Monetization.cs" }),
            ...
            new RegisteredDefine("MODULE_POWERUPS", "Watermelon.PUController", new string[] { "{CORE_MODULES}Power Ups System/Scripts/PUController.cs" }),
            new RegisteredDefine("MODULE_HAPTIC", "Watermelon.Haptic", new string[] { "{CORE_MODULES}Haptic/Scripts/Haptic.cs" }),
            new RegisteredDefine("MODULE_CURVE", "Watermelon.CurvatureManager", new string[] { "{CORE_MODULES}Curve/CurvatureManager.cs" }),
        };
